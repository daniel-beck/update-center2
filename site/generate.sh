...
RSYNC_USER="www-data"
declare -a BASELINES=( 2.32 2.19 2.7 1.651 1.642 1.625 1.609 )
...
function sanity-check() {
    ...
    if [ 700000 -ge $(wc -c "$file" | xargs | cut -f 1 -d ' ') ]; then
...
# /stable
cat <<EOF > htaccess-versions
# Version-specific rulesets generated by generate.sh
$HTACCESS

RewriteRule ^stable/(.+) "/stable-${BASELINES[0]}/\$1" [NC,L,R=301]
EOF
...
pushd www2
    ln -s stable-${BASELINES[0]} stable
